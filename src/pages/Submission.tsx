        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xl text-muted-foreground text-center max-w-3xl mx-auto animate-slide-in mb-12" style={{ animationDelay: '100ms' }}>
              Compartilhe sua pesquisa e conhecimento no mundo equestre através da submissão de resumos expandidos para o Know Horse 2026.
            </p>
                  ...
                  <div className="flex flex-col gap-4 items-center mt-8">
                    ...
                    <div className="pt-6 border-t border-border w-full space-y-4">
                      <div className="flex flex-col space-y-1">
                        <span className="text-sm font-semibold uppercase tracking-wider text-primary">Cronograma</span>
                        <p className="text-sm">Data de envio: de 16 de março a 20 de abril</p>
                        <p className="text-sm">Data de divulgação dos resumos aprovados: 27 de abril</p>
                      </div>
                      
                      <div className="flex flex-col space-y-1">
                        <span className="text-sm font-semibold uppercase tracking-wider text-primary">Contato</span>
                        <p className="text-sm">Email: knowhorse2026submissao@gmail.com</p>
                      </div>
                    </div>
                  </div>
                </div>
