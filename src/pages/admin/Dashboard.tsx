        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-8">
            ...
            <p className="text-xl text-muted-foreground">
              Bem-vindo, {user.email}. Gerencie o Congresso Equestre 2026.
            </p>
          </div>
          ...
          <div className="mb-8 p-6 bg-primary/10 rounded-lg text-center animate-pulse">
            <div className="space-y-2">
              {isLoadingPrices ? (
                ...
                priceLots.map((lot, index) => (
                  <React.Fragment key={lot.number}>
                    {index > 0 && <div className="h-px bg-primary/20 my-3"></div>}
                    <p className="text-xl font-bold text-primary">{lot.period}</p>
                    <p className="text-2xl font-bold text-primary">
                      {lot.label}: R$ {lot.price.toFixed(2).replace('.', ',')}
                    </p>
                  </React.Fragment>
                ))
              )}
