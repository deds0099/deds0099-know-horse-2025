                ...
                >
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="flex-1 flex gap-4">
                      {item.image_url && (
                        <div className="md:block flex-shrink-0 mb-4">
                          <img
                            src={item.image_url}
                            ...
                            onError={(e) => {
                              ...
                              e.currentTarget.src = 'https://placehold.co/300x200/png?text=N/A';
                            }}
                          />
                        </div>
                      )}
                      <div>
                        <h2 className="text-2xl font-semibold mb-2">{item.title || 'Sem título'}</h2>
