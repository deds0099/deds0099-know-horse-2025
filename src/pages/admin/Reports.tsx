...
const Reports = () => {
  ...
  const generatePDF = () => {
    try {
      ...
      // Adicionar título
      doc.setFontSize(20);
      doc.text('Relatório de Inscrições Pagas - Congresso Equestre 2026', 14, 20);
      ...
      // Salvar o PDF
      doc.save('inscricoes-pagas-congresso-equestre-2026.pdf');
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                <CardDescription>Visualize o desempenho e métricas do Congresso Equestre 2026</CardDescription>
              </p>
            </div>
